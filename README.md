...
ERA5 temperature and potentially weather variable grids that have been converted to national and sub-national boundaries for use in 
...
and other papers in progress too.
