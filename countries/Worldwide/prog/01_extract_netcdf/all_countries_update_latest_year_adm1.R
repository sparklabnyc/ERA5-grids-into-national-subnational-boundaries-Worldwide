...
source(paste0(project.folder,'countries/Worldwide/data/objects/objects.R'))
...
source(paste0(project.folder,'countries/Worldwide/prog/01_extract_netcdf/processing_code.R'))
